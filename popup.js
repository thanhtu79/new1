...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='http://www.myphamchonam.com/thuoc-tri-seo/' target='_blank'><img src='http://www.myphamchonam.com/upload/images/banner-maderma-xanh-la-01.png' width='500px'/>Thuốc trị sẹo hiệu quả </a>.dành cho nam giới <h2><a class='close-linhnguyen-modal'>X</a></h2>");
